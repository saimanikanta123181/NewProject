<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Water.aspx.cs" Inherits="CMS.DashBoard_Water" %>
...
<head runat="server">
    ...
    <title></title>
    <style>
        #WaterMonthlyBarChart, #WaterDailyBarChart, #WaterYearlyPieChart, #WaterHourlyBarChart {
...
<script>
    ...
    $(document).ready(function () {
        ...
        getWaterMonthlyData(moment().year());
        getWaterDailyData(moment().format('M'), moment().format('MMM'), moment().year());
        getWaterHourlyData(moment(new Date()).format("DD/MM/YYYY"));
    ...
    function TimeOut(Date) {
        if (TimeId == 1) {
            getWaterMonthlyData(moment(Date, "DD/MM/YYYY").year());
            getWaterDailyData(moment(moment().format('M')).format('M'), moment(moment(Date, "DD/MM/YYYY")).format('MMM'), moment(Date, "DD/MM/YYYY").year());
            getWaterHourlyData(moment(moment(Date, "DD/MM/YYYY")).format('DD/MM/YYYY'));
    ...
    function getWaterMonthlyData(Year) {
        var Status = [];
        var CCount = [];
        $("#txtMonthlyYear").html(Year);
        $.ajax({
            url: "Water.aspx/GetWaterMonthlyData",
            type: "POST",
            dataType: "json",
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                $("#WaterMonthlyChartDiv").empty();
                var str = '<canvas id="WaterMonthlyBarChart" height="220" width="400" style="color:black;"></canvas>';
                $("#WaterMonthlyChartDiv").append(str);
                genrateBarChartForMonthly(Status, CCount, 'WaterMonthlyBarChart', 'blue', 'Monthly')
            },
            error: function (xhr, ajaxOptions, thrownError) { }
        });
    }

    function getWaterDailyData(Month, MonthName, Year) {
        var Status = [];
        var CCount = [];
        ...
        $.ajax({
            url: "Water.aspx/GetWaterDailyData",
            type: "POST",
            dataType: "json",
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                $("#WaterDailyChartDiv").empty();
                var str = '<canvas id="WaterDailyBarChart" height="220" width="400" style="color:black;"></canvas>';
                $("#WaterDailyChartDiv").append(str);
                genrateBarChartForDaily(Status, CCount, 'WaterDailyBarChart', '#40b37c', 'Daily')
            },
            error: function (xhr, ajaxOptions, thrownError) { }
        });
    }
    function getWaterHourlyData(Date) {
        $("#txtHourlyDate").html(Date);
        var Status = [];
        var CCount = [];
        $.ajax({
            url: "Water.aspx/getWaterHourlyData",
            type: "POST",
            dataType: "json",
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                $("#WaterHourlyChartDiv").empty();
                var str = '<canvas id="WaterHourlyBarChart" height="220" width="400" style="color:black;"></canvas>';
                $("#WaterHourlyChartDiv").append(str);
                genrateBarChartForHourly(Status, CCount, 'WaterHourlyBarChart', 'orange', 'Hourly')
            },
            error: function (xhr, ajaxOptions, thrownError) { }
        });
    }
    function genrateBarChartForMonthly(Status, CCount, id, barColor, labelString) {
        ...
        $("#WaterMonthlyBarChart").unbind().click(function (evt) {
            var monthId = '';
            ...
            if (activePoints.length > 0) {
                ...
                getWaterDailyData(monthId, label, $("#txtMonthlyYear").html())
            }
    ...
    function genrateBarChartForDaily(Status, CCount, id, barColor, labelString) {
        ...
        $("#WaterDailyBarChart").unbind().click(function (evt) {
            var activePoints = myChart.getElementsAtEvent(evt);
            if (activePoints.length > 0) {
                var clickedElementindex = activePoints[0]["_index"];
                var label = myChart.data.labels[clickedElementindex];
    ...
    function getWaterYearlyData() {
        var Status = [];
        var CCount = [];
        var AvgReading = [];
        $.ajax({
            url: "Water.aspx/GetWaterYearlyData",
            type: "POST",
            dataType: "json",
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                $("#WaterYearlyChartDiv").empty();
                var str = '<canvas id="WaterYearlyPieChart" height="250" width="400" style="color:black;"></canvas>';
                $("#WaterYearlyChartDiv").append(str);
    ...
    function renderPieChart(Status, CCount) {
        ...
        var ctx = document.getElementById("WaterYearlyPieChart").getContext("2d");
        var myChart = new Chart(ctx, {
            type: 'doughnut',
            data: {
                labels: Status,
        ...
        $("#WaterYearlyPieChart").unbind().click(function (evt) {
            var activePoints = myChart.getElementsAtEvent(evt);
            if (activePoints.length > 0) {
                var clickedElementindex = activePoints[0]["_index"];
                var label = myChart.data.labels[clickedElementindex];
                var value = myChart.data.datasets[0].data[clickedElementindex];
                getWaterMonthlyData(label);
            }
...
<body>
            ...
            <div class="col-md-12 p-0">
                <nav class="navbar navbar-light bg-light navbar-expand-lg p-1" style="background-color: white !important">
                    ...
                    <ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
                        ...
                        <a class="navbar-brand" href="SiteDashboard">
    ...
    <div class="container-fluid">
        <div class="row mt-2">
            ...
            <div class="col-md bg-light card-water-active mr-3">
        ...
        <div class="row p-1 justify-content-center">
            <div class="col-md-6 p-2">
                <div class="bg-light card box-layout">
                    <h6><strong>Monthly Consumption In Ltr</strong><strong style="float: right"><span id="txtMonthlyYear">Comsumption</span></strong></h6>
                    <div id="WaterMonthlyChartDiv">
                    </div>
            ...
            <div class="col-md-6 p-2">
                <div class="bg-light card box-layout">
                    <h6><strong>Daily Consumption In Ltr</strong><strong style="float: right"><span id="txtDailyMonth">Jan</span><span id="txtDailyYear" style="padding-left: 5px"></span></strong></h6>
                    <div id="WaterDailyChartDiv">
                    </div>
                </div>
            </div>
            <div class="col-md-8 p-2">
                <div class="bg-light card box-layout">
                    <h6><strong>Hourly Consumption In Ltr</strong><strong style="float: right"><span id="txtHourlyDate"></span></strong></h6>
                    <div id="WaterHourlyChartDiv">
                    </div>
                </div>
            </div>
        </div>
