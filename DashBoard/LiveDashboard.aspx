<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LiveDashboard.aspx.cs" Inherits="CMS.DashBoard_LiveDashboard" %>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row mt-2">
            ...
            <a href="../DashBoard/LiveDashboard.aspx" title="Dashboard">
                <div class="col-md-1 pt-2">
        ...
        <div class="row p-1">
            ...
            <div class="col-md-4 p-2">
                <div class="bg-light card box-layout">
                    <h6><strong>Water</strong></br>
						<small>Comsumption : <strong><span id="WaterComsumption"><label id="lblWaterComsumption"></label></span></strong> Ltr.<span style="float: right">MTD : <strong><span id="WaterMTD"><label id="lblWaterMTD"></label></span></strong> Ltr.</span></small></h6>
                    <hr />
                    <div id="WaterBarChartDiv">
                    </div>
                </div>
            </div>
            <div class="col-md-4 p-2">
                <div class="bg-light card box-layout">
                    <h6><strong>Gas</strong></br>
						<small>Comsumption : <strong><span id="GasComsumption"><label id="lblGasComsumption"></label></span></strong> KG<span style="float: right">MTD : <strong><span id="GasMTD"><label id="lblGasMTD"></label></span></strong> KG</span></small></h6>
                    <hr />
                    <div id="GasBarChartDiv">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 p-2">
                <div class="bg-light card box-layout">
                    <h6><strong>Fuel</strong>
							<span style="float: right"><small>Comsumption : <strong><span id="FuelComsumption"><label id="lblFuelComsumption"></label></span></strong> Ltr</small></span></h6>
                    <div id="FuelLineChartDiv">
                    </div>
                </div>
            </div>
            <div class="col-md-4 p-2">
                <div class="bg-light card box-layout">
                    <h6><strong>DG</strong></br></h6>
                    <%--<small>Comsumption : <strong><span id="FuelComsumption">12324</span></strong> Ltr</small></h6>--%>
                    <div id="FuelBarChartDiv">
                    </div>
                </div>
            </div>
            <div class="col-md-4 p-2">
                <div class="bg-light card box-layout">
                    <h6><strong>AC</strong></br></h6>
                    <!-- <small>Comsumption : 38 KG<span style="float:right">MTD : 96 KG</span></small></h6> -->
